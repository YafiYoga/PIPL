...
$query = "INSERT INTO layanan (user_id, namalayanan, harga, jenislayanan, gambar ) VALUES ($user_id, '$namalayanan', '$harga', '$jenislayanan', '$gambar' )";
        mysqli_query($connection, $query)
        or die ("Gagal Perintah SQL".mysql_error());
        $_SESSION['pesan'] = 'Data berhasil di tambahkan';
        header('location:proseslayanan.php');
}
